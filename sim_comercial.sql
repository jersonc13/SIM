...
insert  into `sim_vendedorclientes`(`nidvenclientes`,`nidcarclientes`,`nidvendedor`,`nestado`,`cvencliguardar`,`cvencliactualizar`) values (1,1,8,1,'0','0'),(2,2,9,1,'0','0'),(3,7,9,1,'0','0'),(4,7,8,0,'0','0'),(5,6,11,1,'0','0');
