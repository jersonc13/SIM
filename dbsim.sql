...
insert  into `sim_carteraclientes`(`nidcartclientes`,`nidclientes`,`nidempresas`,`nestado`,`ccarcliguardar`,`ccarcliactualizar`) values (1,6,4,1,'0','0');
...
insert  into `sim_opcionusuario`(`nidopcion`,`nidusuario`,`nestado`,`copcusuguardar`,`copcusuactualizar`) values (1,2,1,'0','0'),(2,2,1,'0','0'),(3,2,1,'0','0'),(4,2,1,'0','0'),(5,2,1,'0','0'),(8,2,1,'0','0'),(9,2,1,'0','0'),(10,2,1,'0','0'),(1,1,1,'0','0'),(2,1,1,'0','0'),(5,1,1,'0','0'),(11,2,1,'0','0'),(12,2,1,'0','0'),(13,2,1,'0','0'),(14,2,1,'0','0'),(15,2,1,'0','0'),(16,2,1,'0','0');
...
insert  into `sim_percorreo`(`nidpercorreo`,`ccorreo`,`nidpersona`,`cpercorguardar`,`cpercoractualizar`) values (1,'jersonc13@hotmail.com',4,'0','0'),(2,'j@h.com',5,'0','0'),(3,'jsss@h.com',6,'0','0'),(4,'j@h.com',8,'0','0'),(5,'',9,'0','0'),(6,'',10,'0','0');
...
insert  into `sim_perdireccion`(`nidperdireccion`,`cdireccion`,`nidubigeo`,`nestado`,`cperdirguardar`,`cperdiractualizar`,`nidpersona`) values (1,'Jr Union 1078',1436,1,'0','0',4),(2,'petalos',1154,1,'0','0',5),(3,'petalos',932,1,'0','0',6),(4,'petalos',1312,1,'0','0',8),(5,'petalos',703,1,'0','0',9),(6,'petalos',1471,1,'0','0',10);
...
insert  into `sim_persona`(`nidpersona`,`capellidos`,`cnombres`,`cnomcomercial`,`cdniruc`,`crandom`,`nestado`,`cperguardar`,`cperactualizar`,`nidsexo`,`nidestadocivil`,`nidtipdocumento`) values (1,'García Zárate','Marlon H.','','43501922','1234',1,'2014070243501922','2014070243501922',NULL,NULL,NULL),(2,'Castañeda Purizaca','Jerson','','70257295','1235',1,'2014070243501922','2014070243501922',NULL,NULL,NULL),(3,'Castañeda Purizaca','Jerson Andre','','12312312312','12345',0,'0','0',0,21,19),(4,'Perez Pereda','Juan Jaime','','12312312323','12345',0,'0','0',11,22,19),(5,'Perez cabrera','alonso','','12312312','12345',0,'0','0',11,21,18),(6,'cabrera cabrera','lazaro','','70231233','12345',1,'0','0',11,22,18),(7,'','','Carbon & Miel','10121212122','12345',1,'0','0',0,0,19),(8,'','','Dist. Cumbres SAC','10232233232','12345',1,'0','0',0,0,19),(9,'','','Bodega fitopanpan','12312312312','12345',1,'0','0',0,0,19),(10,'','','Bodega carloncho','12312323421','12345',1,'0','0',0,0,19);
...
CREATE TABLE `sim_personaroles` (
  ...
  `nidpersona` int(11) DEFAULT NULL,
  `nestado` int(11) DEFAULT NULL,
  `cperrolguardar` varchar(30) DEFAULT NULL,
  `cperrolactualizar` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`nidperroles`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

/*Data for the table `sim_personaroles` */

insert  into `sim_personaroles`(`nidperroles`,`nidroles`,`nidpersona`,`nestado`,`cperrolguardar`,`cperrolactualizar`) values (1,6,2,1,'0','0'),(2,7,2,1,'0','0'),(3,6,1,1,'0','0'),(4,6,7,1,'0','0'),(5,6,8,1,'0','0'),(6,7,9,1,'0','0'),(7,7,10,1,'0','0');
...
insert  into `sim_pertelefono`(`nidpertelefono`,`ctelefono`,`nidoperador`,`nidpersona`,`nestado`,`cpertelguardar`,`cpertelactualizar`) values (1,'976980221',15,4,1,'0','0'),(2,'123',14,5,1,'0','0'),(3,'123',15,6,1,'0','0'),(4,'123',15,8,1,'0','0'),(5,'12345222',16,9,1,'0','0'),(6,'123',14,10,1,'0','0');
...
insert  into `sim_productosempresa`(`nidproempresa`,`nidperroles`,`nidproductos`,`nestado`,`cproempguardar`,`cproempactualizar`) values (1,4,1,1,'0','0'),(2,4,4,1,'0','0'),(3,4,3,1,'0','0'),(4,5,5,1,'0','0');
...
insert  into `sim_usuario`(`nidusuario`,`cusuario`,`ccontrasena`,`nestado`,`nidpersona`,`cusuguardar`,`cusuactualizar`,`ntipousuario`) values (1,'43501922','e10adc3949ba59abbe56e057f20f883e',1,1,'2014070243501922','2014070243501922',6),(2,'70255295','e10adc3949ba59abbe56e057f20f883e',1,2,'2014070243501922','2014070243501922',6),(3,'udemo','e10adc3949ba59abbe56e057f20f883e',1,2,'2014070243501922','2014070243501922',6),(16,'cumbres','e10adc3949ba59abbe56e057f20f883e',1,8,'123456','123456',6),(17,'fitopanpan','e10adc3949ba59abbe56e057f20f883e',1,9,'123456','123456',7),(18,'bcarloncho','827ccb0eea8a706c4c34a16891f84e7b',1,10,'123456','123456',7);
...
BEGIN
	...
	VALUES (vapellidos,vnombres,'',vruc,'12345','1','0','0',vsexo,vestadocivil,vtipodocumento);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sim_sp_ins_usuarios`(IN vaccion VARCHAR(30),IN vcusuario VARCHAR(100),IN vccontrasena VARCHAR(100),IN vntipousuario VARCHAR(100),IN vnidpersona VARCHAR(100))
BEGIN
	...
	VALUES (vcusuario,md5(vccontrasena),'1',vnidpersona,'123456','123456',vntipousuario);
...
BEGIN
	...
	INNER JOIN sim_usuario usu ON usu.nidusuario=opus.nidusuario
	INNER JOIN sim_maestra ro ON ro.nidmaestra=usu.ntipousuario
	INNER JOIN sim_personaroles pero ON pero.nidroles=ro.nidmaestra
	WHERE op.nvalor='0' AND opus.nestado='1' AND op.nestado='1' AND pero.nidpersona=vnidpersona
	and opus.nidusuario=vnidpersona;
	...
	SELECT op.nidopcion,op.copcion,op.curl,op.cicono,ro.nidmaestra AS nidroles,op.nvalor AS nidhijo FROM sim_opcion op 
	INNER JOIN sim_opcionusuario opro ON op.nidopcion=opro.nidopcion
	INNER JOIN sim_usuario usu ON usu.nidusuario=opro.nidusuario
	INNER JOIN sim_maestra ro ON ro.nidmaestra=usu.ntipousuario
	INNER JOIN sim_personaroles pero ON pero.nidroles=ro.nidmaestra
	WHERE op.nvalor<>'0' AND opro.nestado='1' AND op.nestado='1' AND pero.nidpersona=vnidpersona AND opro.nidusuario=vnidpersona;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sim_sp_qry_productoxempresa`(IN vaccion VARCHAR(30),IN vnidproductos INT ,IN vcproductos VARCHAR(20))
BEGIN
	IF (vaccion = 'qry_productoxempresa') THEN
	
	SELECT pxe.nidproempresa,pxe.nidperroles,pxe.nidproductos,pxe.nestado,pxe.cproempguardar,pxe.cproempactualizar,pro.cproductos,per.cnomcomercial
...
BEGIN
	...
	SELECT usu.nidusuario,usu.cusuario,usu.ccontrasena,usu.nestado,usu.nidpersona,usu.ntipousuario,mae.cmaestra,per.capellidos,per.cnombres,per.cdniruc
